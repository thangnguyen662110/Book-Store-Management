					...
					<div class="row">
						<div class="col-md-4">
							<div class="card">
								...
								<form:form action="/sachForm" modelAttribute="item" method="post" enctype="multipart/form-data">
								<div class="card-body">
									<div class="form-group">
    <label>Mã sách</label>
    <form:input path="maSach" type="text" class="form-control" placeholder="Mã sách" readonly="true" />
    </div>

									<div class="form-group">
										<label>Tên Sách</label>
										<form:input path="tenSach"  type="text" class="form-control" placeholder="Nhập Tên Sách" required="required"/>
									</div>
									  <div class="form-group">
        ...
        <form:select path="loaiSach.tenLoai" class="form-control">
            <form:options items="${danhSachLoaiSach}" />
									...
									<div class="form-group">
										<label>Tác Giả</label>
										<form:input path="tacGia"  type="text" class="form-control" placeholder="Nhập Tên Tác Giả" required="required"/>
									
									</div>
									<div class="form-group">
										<label>Giá</label>
										<form:input path="gia"  type="text" class="form-control" placeholder="Nhập Giá Sách" required="required"/>
									</div>
									<div class="form-group">
    <label>Năm Xuất Bản</label>
    <form:input path="namXuatBan" type="date" class="form-control" placeholder="Nhập Năm Xuất Bản" required="required"/>
</div>

									<div class="form-group">
										<label>Số Lượng</label>
										<form:input path="soLuong"  type="text" class="form-control" placeholder="Số lượng"  required="required"/>
									</div>
									<div class="mb-3">
									<div class="form-group">
										<label>Nhà Xuất Bản</label>
										<form:input path="nhaXuatBan"  type="text" class="form-control" placeholder="Nhập Nhà Xuất Bản" required="required"/>
									</div>
									</div>
									<div class="mb-3">
									<div class="form-group">
										<label>Xem trước</label>
										<form:input path="xemTruoc"  type="text" class="form-control" placeholder="Nhập Nội Dung Xem Trước" required="required"/>
									</div>
		<div class="mb-3">
    <label for="formFileDisabled" class="form-label">Chọn file hình</label>
    <input name="file" type="file" class="form-control" placeholder="" />
     <input name="fileName" type="text" class="form-control" value="${hinh}" />
    </div>
								...
								<div class="card-action row">
									...
									<button formaction="/sachForm/createSach" class="btn btn-success mx-auto">Thêm</button>
									<button formaction="/sachForm/updateSach" class="btn btn-warning mx-auto">Sửa</button>
						...
						<div class="col-md-8">
							<table class="table table-bordered">
								...
								<div class="d-flex justify-content-center">
									...
									<a class="btn btn-primary mx-auto text-white" href="/sachForm?p=${page.number-1}">Lùi</a>
									<a class="btn btn-primary mx-auto text-white" href="/sachForm?p=${page.number+1}">Tiến</a>
									<a class="btn btn-primary mx-auto text-white" href="/sachForm?p=${page.totalPages-1}">Về Cuối</a>
							</div>
						</div>
					</div>
				</div>
