            ...
            <div class="mx-auto w-50 h-50">
                <form action="/login" method="post">
                    <div class="form-login w-75 h-100 mx-auto">
                        <div class="w-100">
                            <p>Tên Đăng Nhập:</p>
                            <input name="tenDangNhap" class="w-100 mb-3 pl-1 rounded"
                                   type="text" placeholder="Enter your username">

                        </div>
                        <div class="w-100">
                            <p>Mật Khẩu:</p>
                            <input name="matKhau" class="w-100 mb-3 pl-1 rounded"
                        ...
                        <div class="text-center mt-4 mb-4">
                            <a class="ms-2" href="/forgotPassword">Forgot Password</a>
                        </div>
                        <div class="w-75 mx-auto">
                            <button type="submit" class="w-100 mt-4 rounded btn-login">--
                                Log In --
                            </button>
                        </div>
                        <div class="text-center mt-4 mb-4">
